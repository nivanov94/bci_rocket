...
"font-weight: 500;")
        ...
        self.btn_pause = QtWidgets.QPushButton(self.top_frame)
        self.btn_pause.setMinimumSize(QtCore.QSize(60, 30))
        self.btn_pause.setStyleSheet("font: 15pt \"Segoe UI\";\n"
"font-weight: 500;")
        self.btn_pause.setObjectName("btn_pause")
        self.horizontalLayout.addWidget(self.btn_pause)
        self.top_frame_spacer = QtWidgets.QFrame(self.top_frame)
        self.top_frame_spacer.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.top_frame_spacer.setFrameShadow(QtWidgets.QFrame.Raised)
        self.top_frame_spacer.setObjectName("top_frame_spacer")
        self.horizontalLayout.addWidget(self.top_frame_spacer)
        ...
        self.lsl_stream_label = QtWidgets.QLabel(self.top_frame)
        font = QtGui.QFont()
        ...
        font.setWeight(62)
        self.lsl_stream_label.setFont(font)
        self.lsl_stream_label.setStyleSheet("color: rgb(255,0,0);\n"
"font-size: 12pt;")
        self.lsl_stream_label.setText("")
        self.lsl_stream_label.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.lsl_stream_label.setObjectName("lsl_stream_label")
        self.horizontalLayout.addWidget(self.lsl_stream_label)
...
"font-size: 15pt;")
        ...
        self.trial_label = QtWidgets.QLabel(self.top_frame)
        self.trial_label.setStyleSheet("color: rgb(255,230,252);\n"
"font-size: 15pt;")
        self.trial_label.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.trial_label.setObjectName("trial_label")
        self.horizontalLayout.addWidget(self.trial_label)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.title_label.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:72pt; font-weight:600; color:#ffe6fc;\">BCI Rocket</span></p></body></html>"))
        ...
        self.lsl_marker_outlet_lineEdit.setText(_translate("MainWindow", "bci_rocket_marker"))
        ...
        self.game_title_label.setText(_translate("MainWindow", "BCI Rocket"))
        self.score_label.setText(_translate("MainWindow", "Score: 45/45"))
        self.trial_label.setText(_translate("MainWindow", "Trial: 45/45"))
